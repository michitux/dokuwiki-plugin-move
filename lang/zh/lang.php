...
$lang['extensionchange']       = '新文件的扩展名与原文件不相同。';
...
$lang['js']['moveButton']      = '移动文件';
$lang['js']['dialogIntro']     = '输入新的文件地址。您可以更改命名空间，但不能更改文件扩展名。';
$lang['root']                  = '[跟目录]';
